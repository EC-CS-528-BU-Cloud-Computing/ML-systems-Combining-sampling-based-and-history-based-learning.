    ...
    def get_yarn_jobs(self):
        ...
        for job in jobs:
            ...
            yarn_j = YarnJob(
                    ...
                    job_child_id = temp_child_id)  #   AJ_code, last three parameter -- trace_duration_ms_direct, job_parent_id, job_child_id.
...
#            print "AJ-US-CF: TaskInJob", job[JOB_TASKS_KEY]
            ...
            for idx, task in enumerate(job[JOB_TASKS_KEY]):
                ...
                yarn_task = YarnPrototypeContainer(
                        ...
                        tid_within_job = idx+1)   #   Doing +1 as id=0 is for AM. Also, tid_within_job is valid only till there is one task per prototype container.
            ...
            yarn_j.set_deadline_length(temp_deadline_length)
