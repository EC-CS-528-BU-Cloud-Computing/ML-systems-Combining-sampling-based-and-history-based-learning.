...
class YarnRaceContinuousSimulationStartEvent(YarnSimulationStartEvent):
    ...
    def handle(self):
        ...
        next_race_simulation.time_millis = self.state.simulator.getClockMillis() + race_duration
...
class YarnRaceSynchronousSimulationEvent(YarnRaceSimulationEvent):
    ...
    def postpone_scheduling(self):
        ...
        scheduling_resume_event.time_millis = self.state.simulator.getClockMillis() + race_duration
