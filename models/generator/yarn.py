...
from schedulers.yarn import YarnRegularScheduler #, YarnSchedulerType
...
class YarnGenerator(object):
    ...
    def generate_state(self, simulator, args):
        ...
        if user_config.symbex:
            ...
            self.state.experiment_identifier = "" ##JS_edit
            self.state.scheduler_type = user_config.scheduler_type
            self.state.experiment_identifier += (self.state.scheduler_type.name + "-") ##JS_edit
        ...
        sls_parser = SLSParser(
            ...
            vcore_count_source=user_config.vcore_count_source,
        ...
        #    self.state.coordinator_ip = user_config.coordinator_ip
        #    self.state.coordinator_listener_port = user_config.coordinator_listener_port ##JS_rm
