...
from utils import PATIENCE_ORACLE_STATE, THREESIGMA_UTILITY_FUNCTIONS, INVALID_VALUE
    ...
    def schedule(self, node):
        ...
        while True:
            ...
            while queue_idx < len(self.job_queue):
                ...
                if not job.am_launched and task.type is not YarnContainerType.MRAM: #   Jobs might have arrived but their AM is not launched. Then they should not be considered for scheduling.
